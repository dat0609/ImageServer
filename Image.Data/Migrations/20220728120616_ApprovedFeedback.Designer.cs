...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Image.Data.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Image.Data.Models.NotifyUser", b =>
                {
            ...
            modelBuilder.Entity("Image.Data.Models.NotifyUser", b =>
                {
                    b.HasOne("Image.Data.Models.Notification", "Notification")
                        .WithMany("NotifyUsers")
                        .HasForeignKey("NotifyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Image.Data.Models.ApplicationUser", "User")
                        .WithMany("NotifyUsers")
